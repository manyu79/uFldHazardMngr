...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The uFldHazardMngr is a strawman MOOS app for managing hazard  ");
...
void showHelpAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("Usage: uFldHazardMngr file.moos [OPTIONS]                   ");
  blu("=============================================================== ");
  blk("                                                                ");
  showSynopsis();
  blk("                                                                ");
  ...
  blk("      Launch uFldHazardMngr with the given process name         ");
  blk("      rather than uFldHazardMngr.                           ");
  mag("  --example, -e                                                 ");
  ...
  mag("  --version,-v                                                  ");
  blk("      Display the release version of uFldHazardMngr.        ");
  blk("                                                                ");
...
void showExampleConfigAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("uFldHazardMngr Example MOOS Configuration                   ");
  blu("=============================================================== ");
  blk("                                                                ");
  blk("ProcessConfig = uFldHazardMngr                                   ");
  blk("{                                                               ");
  blk("  AppTick   = 4                                                 ");
  blk("  CommsTick = 4                                                 ");
  blk("                                                                ");
...
{
  showReleaseInfo("uFldHazardMngr", "gpl");
  exit(0);
}
